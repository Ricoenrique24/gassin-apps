...
class EditReSupplyTransactionViewModel(
    ...
    fun showResupplyTransaction(id: String) =
        resupplyTransactionRepository.showResupplyTransaction(id)
    ...
    fun updateResupplyTransaction(
        ...
        qty: String,
        totalPayment: String
    ) = resupplyTransactionRepository.updateResupplyTransaction(
        id,
        idStore,
        idUser,
        qty,
